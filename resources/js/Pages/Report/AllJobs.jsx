...
import { Search, Filter, ChevronLeft, ChevronRight, Calendar, Briefcase, Layers } from 'lucide-react';
...
const AllJobs = () => {
    ...
    const jobs = [
        { 
            ...
            responsible: 'นาย สุวัฒน์ ทวิลลาด', 
        ...
        { 
            ...
            totalSteps: 3, 
            currentStep: 2, 
            currentStepName: 'ซ่อมแซม',
            status: 'กำลังดำเนินการ', 
            responsible: 'นาย สิทธิกร บุญณะ', 
        ...
        { 
            ...
            totalSteps: 4, 
            currentStep: 3, 
            currentStepName: 'แก้ไขปัญหา',
            status: 'กำลังดำเนินการ', 
            responsible: 'นาย สมชาย ใจดี', 
        ...
        { 
            ...
            status: 'รอดำเนินการ', 
            responsible: 'นางสาว สมหญิง จริงใจ', 
        ...
        { 
            ...
            totalSteps: 1, 
            currentStep: 1, 
            currentStepName: 'เปลี่ยนหลอดไฟ',
            status: 'รอดำเนินการ', 
            responsible: 'นาย มานะ อดทน', 
             ...
             <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <div className="flex items-center gap-2 text-sm text-slate-500 mb-2">
                        ...
                        <span className="text-gray-900 font-medium">รายการใบงานรวม</span>
                    </div>
                    <h1 className="text-2xl font-bold text-gray-900 tracking-tight flex items-center gap-2">
                        <Layers className="text-orange-500" />
                        รายการใบงานรวม
                    </h1>
                    <p className="text-slate-500 text-sm mt-1">ติดตามสถานะงานทั้งหมดในระบบ</p>
                </div>
                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="bg-slate-50/80 text-slate-600 font-semibold border-b border-slate-200">
                             <tr>
                                ...
                                <th className="px-6 py-4 whitespace-nowrap">ผู้รับผิดชอบ</th>
...
AllJobs.layout = page => <LayoutReport children={page} />
